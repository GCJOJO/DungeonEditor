call F:/UnrealEngine/Engine/Build/BatchFiles/RunUAT.bat -ScriptsForProject=D:/DungeonEditor/DungeonEditor.uproject BuildCookRun -project=D:/DungeonEditor/DungeonEditor.uproject -noP4 -clientconfig=Development -serverconfig=Development -nocompileeditor -ue4exe=F:\UnrealEngine\Engine\Binaries\Win64\UE4Editor-Cmd.exe -utf8output -platform=Win64 -targetplatform=Win64 -build -cook -map=CreateWorld+Entry+MainMenu+Village+PlayWorld+SourceDungeon1 -unversionedcookedcontent -encryptinifiles -pak -manifests -compressed -stage -package -cmdline=" -Messaging" -addcmdline="-SessionId=976E2A2B4009963959E33A80D9B479F6 -SessionOwner='Utilisateur' -SessionName='DungeonEditor' " -archive -archivedirectory=D:/DungeonEditor/Saved/Packages/Win64/ -compile
